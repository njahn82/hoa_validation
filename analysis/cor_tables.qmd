...
The aim of this document is to determine the correlation coefficients for several hybrid open access indicators between hoaddata, Web of Science and Scopus, focusing on country affiliations between 2019 and 2023.
Related research have compared open scholarly data sources and propietory databases at the country-level using Spearman's rank correlation coefficient [@alperin2024analysissuitabilityopenalexbibliometric] and Kendal tau correlation [@Akbaritabar_2024], showing high level of correlations.
