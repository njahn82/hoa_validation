...
By April 2025, the ESAC Transformative Agreement Registry, the primary community-driven evidence source, listed approximately 1,300 agreements.[^esac_registry]
...
Comparative studies confirm it as a suitable alternative to proprietary bibliometric databases [@alperin2024analysissuitabilityopenalexbibliometric; @culbert2024referencecoverageanalysisopenalex].
Notably, @C_spedes_2025 synthesised evidence on both OpenAlex's strengths and its shortcomings for bibliometric analysis.
These include challenges with open access status identification [@jahn2023analysing; @Simard_2024], author attribution [@culbert2024referencecoverageanalysisopenalex], institutional affiliations [@Zhang_2024], and document type classification [@Haupka_2024].
...
hoaddata [@hoaddata], developed and maintained by the author to support open access monitoring and research [@Achterberg_2023; @Jahn_2025], is an R data package that regularly collects information on hybrid open access uptake from multiple openly available data sources.
...
This suggests a different approach towards labelling hybrid open access by Web of Science, which will become more apparent when presenting the open access by publisher.
...
This likely reflects the advantage of using of a curated list to identify hybrid open access journals, rather than depending solely on article-level tags.

The observed variations may compromise comparability across open access monitoring exercises. 
This study suggests that design decisions of these services, in particular dashboards, which have evolved over the years, such as the data sources used, update frequencies, and open access definitions, may substantially affect the results and, consequently, the basis for decision-making [@Salamoura_2024;@pampel2025].
...
It is important to note that the study's estimates of articles from institutions involved in transformative agreements are approximations because of a lack of access to invoice data, which is not usually shared by library consortia and publishers [@Kramer_2024]. 
...
With enhanced open metadata compliance attributable to evolving standards and initiatives in support of negotiations with publishers, particularly through the ESAC initiative and Barcelona Declaration on Open Research Information, the situation is likely to improve.
