  ...
  annotations = list(
    "Journal size\n(log scale)" = (
      ggplot(mapping = aes(x = intersection, y = overlap)) +
        ...
        scale_y_log10(labels =  scales::number_format(big.mark = ","), limits = c(1, 10000)) +
        ggtitle("C")
    ),
    "Articles" = (
...
Figure \ref{fig-upset_coverage_results}C shows the distribution for each combination. It shows that there is a large spread across the journals covered by all three data sources. 
...
Figure \ref{fig-upset_coverage_results_publisher} shows the coverage of hybrid journals in transformative agreements by publisher portfolio according to the ESAC registry.
