...
Transformative agreements have emerged as a much-discussed licensing model for the transition from subscription-based publishing to full open access in the last ten years. 
While these agreements can vary substantially, increasing coordination exists in standardising the negotiation, administration, and evaluation of these agreements. 
Simultaneously, efforts to improve transparency through open data about contracts and payments are growing. 
However, this information remains only partially available through bibliometric databases, limiting large-scale studies about the impact of transformative agreements on the transition of hybrid journals to full open access through increased open access uptake.
This study compares findings from hoaddata, an openly available,  continuously updated dataset on hybrid open access, built on open data from Crossref, OpenAlex and the cOAlition S Journal Checler Tool, with the established bibliometric databases Web of Science and Scopus. 
...
Since their introduction, transformative agreements have sparked considerable academic debate. 
Whilst standardisation activities, particularly through the OA2020 and ESAC (Efficiency and Standards for Article Charges) initiatives, have led to improved workflows between library consortia and publishers, as well as increased open access publishing, the initial focus on a few large publishers by national consortia from high-income countries has drawn criticism. 
Critics have raised concerns about market concentration, the lack of journal flipping to full open access models, reduced competition in the publishing market, and wider gaps between well-resourced and under-resourced institutions and researchers.

For instance, studying over 700 agreements, Jahn (2025) observed a strong growth in open access publishing to 15% in 2022 due to the varying implementation of transformative agreements across countries, predominantly driven by three commercial publishers: Elsevier, Springer Nature, and Wiley.
This aligns with the rapid proliferation of transformative agreements in recent years.
Previously, only a minimal proportion of articles were made open access in hybrid journals (Piwowar, 2018; Laakso, 2016).

Evaluations conducted by library consortia confirm these trends but draw different conclusions.
For instance, the British Joint Information Systems Committee's evaluation (Brayman, Devenney et al., 2024) noted transformative agreements' significant impact on national open access growth but limited effect on global open access transition, suggesting a need to reevaluate their strategy.
Similar policy reconsiderations emerged in Norway and Sweden (Holden, Skoie et al., 2023; Widding, 2024).
...
Conversely, Germany's DEAL consortium extended agreements with major publishers through 2028, while Colombia established Latin America's first transformative agreements (Muñoz-Vélez, Pallares et al., 2024). A recent Max Planck Digital Library study demonstrates how cost savings can be achieved through this model and how it can be further developed to achieve full open access while controlling expenditure.

Open databases like OpenAlex, which build upon Crossref, particularly benefit from these developments.
These resources have gained considerable attention in research evaluation due to their inclusivity, openness, and comprehensive coverage of publication metadata.
Recent studies [REFERENCE NEEDED] have demonstrated that open bibliometric databases increasingly match or exceed the coverage of traditional commercial databases in many disciplines, whilst providing improved access to standardised and interlinked open research information.
...
Only a few studies have attempted this analysis, primarily due to data limitations and the need to combine multiple sources.
Transformative agreements present unique measurement challenges because of their complex workflow requirements, which are not fully reflected in bibliometric databases.
These challenges include varying journal portfolios across agreements, invoicing procedures specific to submitting authors, and article caps that limit open access publishing within agreements.

The present study addresses these gaps by replicating and applying consistent methodologies across Web of Science, Scopus, and open data sources.
This comparative approach enables the research to overcome the limitations of any single source whilst systematically assessing the strengths and weaknesses of different bibliometric data sources for monitoring transformative agreement outcomes.
By triangulating findings across these platforms, the study aims to provide a more comprehensive understanding of how transformative agreements influence hybrid open access publishing patterns within the ongoing scholarly publishing transition.
...
Open questions remain whether this uneven distribution reflects temporary implementation gaps, inherent inequities in the transformative agreement model, or countries deliberately refraining from such agreements.
...
Notably, the results show strong correlations by country affiliation, aligning with previous studies [@Akbaritabar_2024; @alperin2024analysissuitabilityopenalexbibliometric] and rankings [@eck_2024_6bx73], which supports using open metadata for large-scale analyses of hybrid open access. 
...
The coverage analysis reveals that hybrid journals are well indexed in all three data sources, particularly in terms of article coverage.
...
Using the open index Crossref as a bibliometric database in hoaddata demonstrated particular strength in identifying newly established hybrid journals, a notable finding given that transformative agreements primarily target existing subscription-based journals.

The landscape of hybrid journal publishing differs markedly from that of fully open access journals.
...
Notably, journals that charge no publication fees ("diamond journals") are absent from the selective Web of Science, which reinforces existing disparities in the indexing of underrepresented research communities and regions in selective bibliometric databases (ref).
...
Previous research has highlighted how institutionalized bibliometric practices can affect the valuation of authorship positions [@Helgesson_2020], suggesting the need to monitor potential influences on authorships [@Maddi_2024].
...
Given these variations, which may compromise comparability, research and monitoring exercises should avoid reliance on a single source. Instead, the selection of open access evidence should be cross-verified using multiple sources [@Huang_2020]. Incorporating expert-curated journal lists can also help prevent misclassifications based on business models [@Visser_2021].
...
With enhanced and streamlined metadata compliance, attributable to evolving standards and initiatives to support negotiations with publishers, particularly through the communities of the ESAC initiative and Barcelona Declaration supporters, the situation is likely to improve. In conclusion, this study has shown that open scholarly data are suitable for analysing the transition from subscription-based publishing to full open access.
