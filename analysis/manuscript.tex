...
Figure \ref{fig-upset_coverage_results_publisher} illustrates the
coverage of hybrid journals in transformative agreements by publisher
portfolio according to the ESAC registry between 2019 and 2023. Elsevier
was best represented in the union set of all investigated databases,
with 1,672 hybrid journals with at least one open access article that
published 2,345,205 articles between the five-year period. Springer
Nature followed with 1,561 hybrid journals publishing 1,058,564
articles, and Wiley with 1,151 hybrid journals and 770,546 articles. The
remaining 54 publishers recorded a total of 6,476 hybrid journals that
published 2,115,372 articles.

Notably, the three largest publishers--Elsevier, Springer Nature and
Wiley--were well represented in the exclusive intersection of all three
data sources examined. In terms of journal coverage, they accounted for
4,384 (55\%) of the hybrid journals included in the intersection. This
dominance is even more pronounced in terms of article coverage, with
these publishers having a joint indexing coverage of 4,174,315 articles
(66\%).
...
When considering journals exlcusively covered by Scopus and Web of
Science
