...
focussing on the influence of transformative agreements across hoaddata,
Scopus and Web of Science. The analysis aims to determine whether
consistent results can be derived from these three data sources despite
their differing coverage and methodologies. Following Jahn (2025),
indicators include the number and proportion of open access articles,
both overall and those specifically enabled by transformative
agreements. The analysis compares the development of these indicators
over time between 2019 and 2023 across all three data sources.
...
Scopus (orange line) and Web of Science (blue line). In 2023, hybrid
open access uptake reached 19\% in hoaddata (n = 302,358) and Scopus (n
= 322,850), and 20\% in Web of Science (n = 255,481.

The number and proportion of open access articles enabled through
transformative agreements increased between 2019 and 2023 (Figures
\ref{fig-uptake_overview}B and C). These trends remained consistent when
estimating open access via first author (dashed line) and corresponding
author (dotted line) affiliation metadata. Using Scopus, it was possible
to attribute 479,297 open access articles to transformative agreements
...
agreements using first author metadata ( growing from 21,871 to 174,126)
and 500,076 using corresponding author metadata (from 22,092 to
177,030). The development over the years for hoadata is shown only for
first authors due to unavailable corresponding author data. In total,
hoaddata linked 501,649 open access articles to transformative
agreements, making it the most comprehensive data source for
first-author analysis. However, hoaddata showed slower growth compared
to the other two data sources, as illustrated by its fewer articles than
Scopus in 2023. Furthermore, Scopus and Web of Science recorded slighlty
fewer articles for first author articles than those reported for
corresponding authors.

When considering the percentage of hybrid open access through
transformative agreements relative to total open access, all data
sources consistently indicate that between 2021 and 2022, the majority
of open access was enabled by transformative agreements. This trend can
be obsverved for both first and corresponding author affiliations. For
first authors, the share of open access ranged between 68 \% (Web of
Science), 64\% (Scopus) and 61\% (hoaddata). For corresponding authors,
the share was slighly larger, with Web of Science recording 69 \% and
Scopus 65\%) Nevertheless, substantial amounts of hybrid open access
were still facilitated by means other than transformative agreements,
likely through APCs invoiced to researchers and paid from research
funds.

Despite these similarities, the results also reveal notable differences.
Specifically, the Web of Science recorded substantially higher open
access uptake in the early years compared to Scopus and hoaddata, before
converging in 2023. This suggests that delayed open access, i.e., open
access after an embargo period, was labeled as hybrid open access in the
Web of Science.

\subsubsection{Open access by
publishers}\label{open-access-by-publishers}

When considering open access trends by publisher, it becomes evident
that in particular due to Elsevier, the largest publsiher in our sample.
Following Jahn (2025), Figure \ldots{}

\begin{center}
\includegraphics[width=0.99\linewidth,height=\textheight,keepaspectratio]{fig/plot_publisher_uptake_overview-1.pdf}
\end{center}
