...
Transformative agreements have emerged as a much-discussed licensing
model for the transition from subscription-based publishing to full open
access in the last ten years. While these agreements can vary
substantially, increasing coordination exists in standardising the
negotiation, administration, and evaluation of these agreements.
Simultaneously, efforts to improve transparency through open data about
contracts and payments are growing. However, this information remains
only partially available through bibliometric databases, limiting
large-scale studies about the impact of transformative agreements on the
transition of hybrid journals to full open access through increased open
access uptake. This study compares findings from hoaddata, an openly
available, continuously updated dataset on hybrid open access, built on
open data from Crossref, OpenAlex and the cOAlition S Journal Checler
...
Since their introduction, transformative agreements have sparked
considerable academic debate. Whilst standardisation activities,
...
publishing, the initial focus on a few large publishers by national
consortia from high-income countries has drawn criticism. Critics have
raised concerns about market concentration, the lack of journal flipping
to full open access models, reduced competition in the publishing
market, and wider gaps between well-resourced and under-resourced
institutions and researchers.

For instance, studying over 700 agreements, Jahn (2025) observed a
strong growth in open access publishing to 15\% in 2022 due to the
varying implementation of transformative agreements across countries,
predominantly driven by three commercial publishers: Elsevier, Springer
Nature, and Wiley. This aligns with the rapid proliferation of
transformative agreements in recent years. Previously, only a minimal
proportion of articles were made open access in hybrid journals
(Piwowar, 2018; Laakso, 2016).

Evaluations conducted by library consortia confirm these trends but draw
different conclusions. For instance, the British Joint Information
Systems Committee's evaluation (Brayman, Devenney et al., 2024) noted
transformative agreements' significant impact on national open access
growth but limited effect on global open access transition, suggesting a
need to reevaluate their strategy. Similar policy reconsiderations
emerged in Norway and Sweden (Holden, Skoie et al., 2023; Widding,
2024). Meanwhile, cOAlition S recommended ending financial support for
these agreements in 2024, but still considers hybrid open access
compliant with funder open access policies. Conversely, Germany's DEAL
consortium extended agreements with major publishers through 2028, while
Colombia established Latin America's first transformative agreements
(Muñoz-Vélez, Pallares et al., 2024). A recent Max Planck Digital
Library study demonstrates how cost savings can be achieved through this
model and how it can be further developed to achieve full open access
while controlling expenditure.

Open databases like OpenAlex, which build upon Crossref, particularly
benefit from these developments. These resources have gained
considerable attention in research evaluation due to their inclusivity,
openness, and comprehensive coverage of publication metadata. Recent
studies {[}REFERENCE NEEDED{]} have demonstrated that open bibliometric
databases increasingly match or exceed the coverage of traditional
commercial databases in many disciplines, whilst providing improved
access to standardised and interlinked open research information.
...
open access. Only a few studies have attempted this analysis, primarily
due to data limitations and the need to combine multiple sources.
Transformative agreements present unique measurement challenges because
of their complex workflow requirements, which are not fully reflected in
bibliometric databases. These challenges include varying journal
portfolios across agreements, invoicing procedures specific to
submitting authors, and article caps that limit open access publishing
within agreements.

The present study addresses these gaps by replicating and applying
consistent methodologies across Web of Science, Scopus, and open data
sources. This comparative approach enables the research to overcome the
limitations of any single source whilst systematically assessing the
strengths and weaknesses of different bibliometric data sources for
monitoring transformative agreement outcomes. By triangulating findings
across these platforms, the study aims to provide a more comprehensive
understanding of how transformative agreements influence hybrid open
access publishing patterns within the ongoing scholarly publishing
transition.
...
transformative agreement model, or countries deliberately refraining
...
and rankings (Eck et al., 2024), which supports using open metadata for
large-scale analyses of hybrid open access. However, the observed
differences in journal coverage and metadata availability warrant
...
Differences emerge for journals targeting practitioners or local
...
The landscape of hybrid journal publishing differs markedly from that of
fully open access journals. Comparing the coverage of OpenAlex, Scopus
and Web of Science, Simard et al. (2024) indicate that only half of the
fully open access journals listed in the DOAJ are also indexed in Scopus
and Web of Science. Notably, journals that charge no publication fees
(``diamond journals'') are absent from the selective Web of Science,
which reinforces existing disparities in the indexing of
...
Despite this correlation, the study observed a recent slight increase in
open access articles by corresponding authors over first authors across
Springer Nature hybrid journals prompts questions about how
institutional open access sponsorship practices influence author roles
and assignments within co-author teams, especially as funding
opportunities vary (Gumpenberger et al., 2018). Previous research has
highlighted how institutionalized bibliometric practices can affect the
valuation of authorship positions (Helgesson, 2020), suggesting the need
to monitor potential influences on authorships (Maddi \& Silva, 2024).
...
enhanced and streamlined metadata compliance, attributable to evolving
standards and initiatives to support negotiations with publishers,
particularly through the communities of the ESAC initiative and
Barcelona Declaration supporters, the situation is likely to improve. In
conclusion, this study has shown that open scholarly data are suitable
for analysing the transition from subscription-based publishing to full
open access.
