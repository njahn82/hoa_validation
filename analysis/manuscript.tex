...
data sources, despite their differing coverage and methodologies.

\begin{center}
\includegraphics[width=0.99\linewidth,height=\textheight,keepaspectratio]{fig/plot_uptake_overview-1.pdf}
\end{center}
