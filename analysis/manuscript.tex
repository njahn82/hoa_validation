...
towards labelling hybrid open access by Web of Science, which will
become more apparent when presenting the open access by publisher.
...
depending solely on article-level tags.
...
such as the data sources used, update frequencies, and open access
definitions, may substantially affect the results and, consequently, the
basis for decision-making (Pampel \& Schneider, 2025; Salamoura \&
Tsakonas, 2024). Therefore, monitoring exercises might benefit from
avoiding reliance on a single source. Instead, the selection of open
access evidence could be cross-verified using multiple sources and
snapshots that can be used to track changes in the data over time (C.-K.
Huang et al., 2020). Incorporating expert-curated journal lists may also
help reduce misclassification based on business models (Visser et al.,
2021). Additionally, stakeholders should advocate for greater
transparency from monitoring service providers in their methodological
choices and data processing decisions (Kramer, 2024).
...
situation is likely to improve. For example, AIP Publishing and Emerald,
whose hybrid journal portfolios could not be included in this study due
to a lack of CC licence information, have recently begun sharing this
metadata via Crossref. Furthermore, during the 17th Berlin Open Access
Conference (B17), an international conference organised by the OA2020
Initiative, research organisations and their library consortia
emphasised the importance of open research information for achieving
transparency. In conclusion, this study has shown that open metadata are
...
Pampel, H., \& Schneider, J. (2025, June 12). \emph{Open {Access}
{Dashboard} {Collection} {Launched}}. {Research Group Information
